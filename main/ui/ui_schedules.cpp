...
static void create_schedules_screen(void) {
    ...
    lv_obj_set_style_bg_color(s_schedules_screen, lv_color_hex(0x121212), 0);
    lv_scr_load(s_schedules_screen);
    ...
    if (ret == ESP_OK && count > 0) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            lv_obj_set_style_text_color(lecturer_lbl, lv_color_hex(0xDDDDDD), 0);
        ...
        lv_obj_set_style_bg_color(empty_card, lv_color_hex(0x1E1E1E), 0);
